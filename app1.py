# CyberSecureSim: Advanced Steganography-Aware Firewall Simulator with Admin/User Login (Streamlit GUI)
...
st.title("🛡️ CyberSecureSim")
st.subheader("Firewall + Steganography Security Simulator")
...
if login_success:
    ...
    # ---------- Tabs ----------
    tabs = st.tabs(["🖼️ Image Steganography", "🌐 URL / Command", "📁 File Upload"])
    ...
    with tabs[0]:
        ...
        if uploaded_image:
            ...
            if is_encrypted(decoded_text):
                st.warning("⚠️ This message looks encrypted. Blocking.")
